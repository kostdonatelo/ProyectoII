...
session_start();
//si la variable de sesion no existe me regresara al login
...
$row = $resultado->fetch_assoc(); //recorrer la tabla usuario y mostar el nombre 
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<div class="sidebar-toggle sidebar-collapse" id="sidebar-collapse">
					...
					<input type="button" value="Cliente" onclick="location.href='admin.php' "><br/>
					<input type="button" value="Pedidos" onclick="location.href='pedidos.php' "><br>
					<input type="button" value="Realizar Entrega" onclick="location.href='salir.php' "><br>
					<input type="button" value="Repartidores" onclick="location.href='salir.php' "><br>
				</div>
			</div>
        ...
        <form id="form1" action="procesar.php" method="post" class="needs-validation" novalidate>
                  <div class="form-row">
                    <div class="col-md-4 mb-3">
                      ...
                      <input name="Idcliente" type="text" class="form-control" id="Idcliente" placeholder="" value="" required>
                  ...
                  <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <input name="NombreProducto" type="text" class="form-control" id="NombreProducto" placeholder="" required>
                      <div class="valid-feedback">¡Ok válido!</div>
                      <div class="invalid-feedback">Complete el campo.</div>   
                    </div>
